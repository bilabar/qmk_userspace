...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LCTL_T(KC_ESC), KC_A, KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_ENT,
        ...
        KC_LCTL, KC_LALT, KC_LWIN,                            KC_SPC,                             _______, KC_RWIN, KC_RALT, KC_RCTL
    ),
    [_FN] = LAYOUT_all(
        ...
        SOCD_TOGG, _______, SOCD_ON, SOCD_OFF, _______, _______, _______, _______, _______, KC_END,  KC_PGDN, KC_DOWN, _______, _______,
