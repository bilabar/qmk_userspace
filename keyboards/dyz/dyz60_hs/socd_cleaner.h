...
typedef struct {
  bool enable;
  socd_cleaner_pair_t pairs[2];
} socd_cleaner_config_t;

_Static_assert(sizeof(socd_cleaner_config_t) == EECONFIG_KB_DATA_SIZE, "Mismatch in keyboard EECONFIG stored data");
